...
public class AlternatingCase {
    public static String toAlternativeString(String string) {
        ...
        for (Character charArr : arr) {
            if (charArr == Character.toLowerCase(charArr) ) {
                builder.append(Character.toUpperCase(charArr));
            }
            if (charArr != Character.toLowerCase(charArr)) {
                builder.append(Character.toLowerCase(charArr));
            }
        }
